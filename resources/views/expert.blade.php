@extends('layout')
@section('page_title')Expert, welcome!@endsection
                        ...
                        <div class="col-3">
                            <div class="list-group" id="list-tab" role="tablist">
                                <a class="list-group-item list-group-item-action active" id="list-home-list"
                                    data-toggle="list" href="#list-home" role="tab" aria-controls="home">Контрактные клиенты</a>
                        ...
                        <div class="col-9">
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="list-home" role="tabpanel"
                                    aria-labelledby="list-home-list">Клиенты, с которыми уже заключён контракт
                                ...
                                <div class="tab-pane fade" id="list-example" role="tabpanel"
